...
const Footer = ({ theme }) => {
    ...
    return (
        <footer className="footer sm:footer-horizontal bg-base-300 p-10">
            ...
            <nav>
                <Link to="/" className="link no-underline hover:text-primary">首頁</Link>
                <Link to="/make" className="link no-underline hover:text-primary">製作便當</Link>
                <Link to="/catlog" className="link no-underline hover:text-primary">食品型錄</Link>
            </nav>
            <nav>
                <Link to="/profile" className="link no-underline hover:text-primary">個人頁面</Link>
                {
                    user ?
                        <button
                            onClick={() => dispatch(logout())}
                            className="link no-underline hover:text-secondary"
                        >登出</button>
                        :
                        <Link to="/login" className="link no-underline hover:text-primary">登入/註冊</Link>
                }
